    ...
    return (
        <>
            <div className="listingSingleblock mb-4" id="spot-photos">
                <div className="SingleblockHeader d-flex align-items-center justify-content-between">
                    <h4 className="listingcollapseTitle mb-0">Photos</h4>
                    {user && (
                        <>
                            <input
                                ref={fileInputRef}
                ...
                <div className="card-body p-4 pt-3">
                    {photos.length === 0 ? (
                        <p className="text-muted mb-0">No photos yet. Be the first to share one!</p>
                    ) : (
                    ...
                    >
                        <div>
                            ...
                            <span className="text-white-50" style={{ fontSize: '0.85rem' }}>
                                by {photos[activeIndex].user_profiles?.full_name || photos[activeIndex].user_profiles?.username || 'Unknown'}
                            </span>
                        </div>

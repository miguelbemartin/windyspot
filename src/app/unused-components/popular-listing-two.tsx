...
export default function PopularListingTwo({ spots }: { spots: SpotWithLocation[] }) {
  return (
                                ...
                                <div className="singlelisting-item">
                                    ...
                                    <div className="listing-middle-item">
                                        ...
                                        <div className="listing-info-details">
                                            <div className="d-flex align-items-center justify-content-start gap-2">
                                                <div className="list-distance"><BsGeoAlt className="mb-0 me-2"/>{item.location.name}</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="listing-footer-item">
                                        <div className="d-flex align-items-center justify-content-between gap-2">
                                            ...
                                            <div className="listing-shares">
                                                <div className="d-flex align-items-center justify-content-start gap-2">
                                                    <Link href="/single-listing-01" className="smallLinks" data-bs-toggle="tooltip" data-bs-title="View Listing"><BsEyeFill className="m-0"/></Link>
                                                    <Link href="/single-listing-01" className="smallLinks" data-bs-toggle="tooltip" data-bs-title="Save Listing"><BsSuitHeart className="m-0"></BsSuitHeart></Link>
                                                    <Link href="/single-listing-01" className="smallLinks" data-bs-toggle="tooltip" data-bs-title="Share Listing"><BsShareFill className="m-0"/></Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

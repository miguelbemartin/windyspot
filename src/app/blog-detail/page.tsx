                        ...
                        <div className="blogDetails d-flex align-items-start gap-4 flex-column w-100">
                            <div className="card shadow-sm w-100">
                                <div className="blogThumb">
                                    <Image src="/img/gal-4.jpg" width={0} height={0} sizes='100vw' style={{width:'100%', height:'auto'}} className="img-fluid" alt="Blog Thumb"/>
                                </div>
                                <div className="card-body">
                                    <div className="d-inline-flex mb-2"><span className="badge badge-xs badge-primary rounded-pill">Software & Tools</span></div>
                                    <h1 className="fs-3">Top 10 Free Bootstrap Templates for Your Next Project</h1>

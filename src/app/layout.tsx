...
import MixpanelIdentify from './components/mixpanel-identify'
        ...
        <body>
          ...
          <Script id="mixpanel" strategy="afterInteractive">
            {`
              ...
              mixpanel.init('e262eb847484033e2f8c05c345812fda',{autocapture:true,record_sessions_percent:100,api_host:'https://api-eu.mixpanel.com'});
            `}
          </Script>
          <main>{children}</main>
          <MixpanelIdentify />

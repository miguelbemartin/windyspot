...
export default function ListLayoutFour() {
  return (
    <>
        <NavLightTwo/>
                                    ...
                                    <div className="row align-items-center justify-content-start g-3">
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                                            <div className="listThumb overflow-hidden position-relative">
                                                ...
                                                <Link href={`/single-listing-04/${item.id}`} className="d-block"><Image src={item.image} width={0} height={0} sizes='100vw' style={{width:'100%', height:'100%'}} className="img-fluid list-thumb object-fit" alt="Listing Img"/></Link>
                                            </div>
                                        </div>
                                            ...
                                            <div className="listCaption px-3 py-4">
                                                <div className="listTitle d-block mb-4">
                                                    <div className="d-flex align-items-start justify-content-between gap-2">
                                                        ...
                                                        <div className="flex-last">
                                                            <Link href={`/single-listing-04/${item.id}`} className="bookmarkList"><FaHeart className=""></FaHeart></Link>
                                                        </div>
                                                    </div>
                                                </div>

...
import Pricings from '../../unused-components/list-detail/pricings'
...
import SingleSidebarOne from '../../unused-components/single-sidebar-one'
                                ...
                                <div className="firstColumn">
                                    <div className="listingFirstinfo d-flex align-items-center justify-content-start gap-3 flex-wrap">
                                        <div className="listingAvatar">
                                            <Link href="#" className="d-block"><Image src='/img/logo-1.png' width={0} height={0} sizes='100vw' style={{width:'95px', height:'auto'}} className="img-fluid rounded-3" alt="Avatar"/></Link>
                                        </div>
                                        <div className="listingCaptioninfo">
                                            <div className="propertyTitlename d-flex align-items-center gap-2 mb-1"><h2 className="fw-semibold text-light mb-0">Liman Restaurant</h2><span className="verified mt-1"><img src='/img/tick.svg' className="img-fluid" width="22" alt="Verified Listing"/></span></div>
                                            <div className="listingsbasicInfo">
                                                <div className="d-flex align-items-center justify-content-start flex-wrap gap-2">
                                                    ...
                                                    <div className="flexItem me-2"><span className="text-md fw-medium text-light d-flex align-items-center"><BiBriefcase className="me-2"/>Eat & Drink</span></div>

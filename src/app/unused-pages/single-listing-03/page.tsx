...
import FeatureNav from '../../unused-components/navbar/feature-nav'
import Descriptions from '../../components/list-detail/descriptions'
import PricingTwo from '../../unused-components/list-detail/pricing-two'
import Products from '../../unused-components/list-detail/products'
import Features from '../../unused-components/list-detail/features'
import Galleries from '../../unused-components/list-detail/galleries'
import Maps from '../../unused-components/list-detail/maps'
import Statistics from '../../unused-components/list-detail/statistics'
import Reviews from '../../unused-components/list-detail/reviews'
import List from '../../unused-components/list-detail/list'
import SingleSidebarThree from '../../unused-components/list-detail/single-sidebar-three'
...
export default function SingleListingThree() {
  return (
    <>
      <NavbarDark/>
      <section className="bg-cover position-relative ht-500 py-0" style={{backgroundImage:`url('/img/single-3.jpg')`}} data-overlay="4">
                              ...
                              <div className="firstColumn">
                                  <div className="listingFirstinfo d-flex align-items-center justify-content-start gap-3 flex-wrap">
                                      <div className="listingAvatar">
                                          <Link href="#" className="d-block"><Image src='/img/logo-3.png' width={95} height={95} className="img-fluid rounded-3" alt="Avatar"/></Link>
                                      </div>
                                      <div className="listingCaptioninfo">
                                          <div className="propertyTitlename d-flex align-items-center gap-2 mb-1"><h2 className="fw-semibold text-light mb-0">Groom Barber Shop</h2><span className="verified mt-1"><img src='/img/tick.svg' className="img-fluid" width="22" alt="Verified Listing"/></span></div>
                                          <div className="listingsbasicInfo">
                                              <div className="d-flex align-items-center justify-content-start flex-wrap gap-2">
                                                  <div className="flexItem me-2"><span className="text-md fw-medium text-light d-flex align-items-center"><FaLocationDot className="me-2"/>Old Paris, France</span></div>
                                                  <div className="flexItem me-2"><span className="text-md fw-medium text-light d-flex align-items-center"><BsBriefcase className="me-2"/>Services</span></div>
                                                  <div className="flexItem">
                                                      <div className="d-flex align-items-center justify-content-start gap-2">
                                                          ...
                                                          <span className="text-md fw-medium text-light">(4.6k Reviews)</span>
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>

...
export default function GridLayoutThree() {
  return (
    <>
        <ThemNavbar/>

        <div className="image-cover hero-banner overflow-hidden py-5" style={{backgroundImage:`url('/img/brand-section.png')` , backgroundColor:'#ffe8ee'}}>
                                        ...
                                        <div className="listingitem-container">
                                            <div className="singlelisting-item">
                                                <div className="listing-top-item">
                                                    <Link href={`/single-listing-03/${item.id}`} className="topLink">
                                                    ...
                                                    <div className="position-absolute end-0 bottom-0 me-3 mb-3 z-2">
                                                        <Link href={`/single-listing-03/${item.id}`} className="bookmarkList" data-bs-toggle="tooltip" data-bs-title="Save Listing"><BsSuitHeart className="m-0"/></Link>
                                                    </div>
                                                </div>
                                                <div className="listing-middle-item">
                                                    <div className="listing-avatar">
                                                        <Link href={`/single-listing-03/${item.id}`} className="avatarImg"><Image src={item.user} width={0} height={0} sizes='100vw' style={{width:'100%', height:'100%'}} className="img-fluid circle" alt="Avatar"/></Link>
                                                    </div>
                                                    ...
                                                    <div className="d-flex align-items-center justify-content-between gap-2">
                                                        <div className="catdWraps">
                                                            <div className="flex-start">
                                                                <Link href={`/single-listing-03/${item.id}`} className="d-flex align-items-center justify-content-start gap-2">

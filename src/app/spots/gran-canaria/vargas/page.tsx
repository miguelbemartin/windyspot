                                    ...
                                    <div className="listingFirstinfo d-flex align-items-center justify-content-start gap-3 flex-wrap">
                                        <div className="listingCaptioninfo">
                                            <div className="propertyTitlename d-flex align-items-center gap-2 mb-1">
                                                <h2 className="fw-semibold text-light mb-0">Vargas</h2>
                                            </div>
                    ...
                    <div className="col-12">
                        ...
                        <div className="listingSingleblock mb-4" id="forecast">
                            ...
                            <div className="card-body p-4 pt-2">
                                <WindguruWidget spotId="TODO" uid="wg_fwdg_TODO_100_vargas" />
                            </div>
                            </div>
                        </div>
                            ...
                            <div className="card-body p-4 pt-2">
                                <div className="row g-4">
                                    <div className="col-md-6">
                                        <YouTubeEmbed videoId="TODO" title="Vargas Webcam" />
                                    </div>
                                    <div className="col-md-6">
                                        <YouTubeEmbed videoId="TODO" title="Vargas Webcam 2" />
                                    </div>
                                </div>
                            </div>
                            </div>

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://orwtlksbpmgpijcdtngr.supabase.co/storage/v1/object/public/public-images/spots/michele-marchesi-o3ys6oKoHtA-unsplash.jpg', width: 1200, height: 630, alt: 'Sotavento Windsurf Spot' }],
  },
  twitter: {
  ...
  return (
    <>
        ...
        <section className="position-relative ht-200 py-0" style={{ backgroundColor: '#1a2332' }} data-overlay="4">
                <Image src="https://orwtlksbpmgpijcdtngr.supabase.co/storage/v1/object/public/public-images/spots/michele-marchesi-o3ys6oKoHtA-unsplash.jpg" alt="Windsurfing at Sotavento in Fuerteventura" fill sizes="100vw" style={{ objectFit: 'cover' }} priority />
                    ...
                    <div className="col-12">
                        ...
                        <div className="listingSingleblock mb-4" id="livestation">
                            ...
                            <div id="livestationPanel" className="panel-collapse collapse show">
                                <div className="card-body p-4 pt-2">
                                    <WindguruLive spotId="373" uid="wglive_373_sotavento" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="card-body p-4 pt-2">
                                <div className="row g-4">
                                    <div className="col-md-6">
                                        <YouTubeEmbed videoId="DeU_ojR72B4" title="Sotavento Webcam" />
                                    </div>
                                    <div className="col-md-6">
                                        {/* TODO: Add second webcam when available */}
                                    </div>
                                </div>
                            </div>
                            </div>

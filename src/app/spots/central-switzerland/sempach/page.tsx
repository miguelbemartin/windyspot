  ...
  return (
    <>
        ...
        <section className="position-relative ht-200 py-0" style={{ backgroundColor: '#1a2332' }} data-overlay="4">
                <Image src="https://orwtlksbpmgpijcdtngr.supabase.co/storage/v1/object/public/public-images/spots/marvin-meyer-ua_tu9vqLAU-unsplash.jpg" alt="Windsurfing at Sempach on Lake Sempach" fill sizes="100vw" style={{ objectFit: 'cover' }} priority />

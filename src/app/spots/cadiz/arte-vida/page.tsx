  ...
  return (
    <>
        ...
        <section className="position-relative ht-200 py-0" style={{ backgroundColor: '#1a2332' }} data-overlay="4">
                <Image src="https://orwtlksbpmgpijcdtngr.supabase.co/storage/v1/object/public/public-images/spots/david-vives-zD6sFNw__u4-unsplash.jpg" alt="Windsurfing at Arte Vida in Tarifa" fill sizes="100vw" style={{ objectFit: 'cover' }} priority />
                                    ...
                                    <div className="listingFirstinfo d-flex align-items-center justify-content-start gap-3 flex-wrap">
                                        <div className="listingCaptioninfo">
                                            <div className="propertyTitlename d-flex align-items-center gap-2 mb-1">
                                                <h1 className="fw-semibold text-light mb-0">Arte Vida</h1>
                                            </div>
                    ...
                    <div className="col-12">
                        ...
                        <div className="listingSingleblock mb-4" id="forecast">
                            ...
                            <div className="card-body p-4 pt-2">
                                <div className="mb-4">
                                    <WeatherForecastTable lat={36.044} lon={-5.638} />
                                </div>

  ...
  return (
    <>
        ...
        <section className="position-relative ht-200 py-0" style={{ backgroundColor: '#1a2332' }} data-overlay="4">
                <Image src="https://orwtlksbpmgpijcdtngr.supabase.co/storage/v1/object/public/public-images/spots/luke-scarpino-ngRNC_h2G8E-unsplash.jpg" alt="Windsurfing at Hookipa in Maui" fill sizes="100vw" style={{ objectFit: 'cover' }} priority />
